    ...
    if (self.balance> 0):
        ...
        for i in range (len(self.consumption)):
            if (self.production[i]>data['offerThreshold']):
                ...
                dataToPost={"offerer":currentProsumer.idProsumer,"assetId":myAsset.assetID,"beginTimeSlot":beginTime,"endTimeSlot":endTime,"validityLimit":endTime,"offeredQuantity":offeredQuantity,"price":price,"deposit":deposit}
